        ...
        <tr>
            ...
            <td style="width: 50%; vertical-align: top; padding-right: 22px; border: none;">
                ...
                <table style="width: 100%; font-size: 13px; color: #000; border-collapse: collapse;">
                    ...
                    <tr><td style="padding: 4px 0; border: none;"><b>Languages:</b></td><td style="border: none;">{languages}</td></tr>
                    <tr><td style="padding: 4px 0; border: none;"><b>Marital Status:</b></td><td style="border: none;">{marital_status}</td></tr>
                    <tr><td style="padding: 4px 0; border: none;"><b>Nationality:</b></td><td style="border: none;">Indian</td></tr>
                </table>
